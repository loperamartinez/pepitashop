...
export const generatePaginationNumbers = (currentPage: number, totalPages: number) => {
    ...
    ///Se mostrará todas las páginas sin puntos suspensivos.

    if(totalPages <= 7){
        return Array.from({length: totalPages}, (_, i) => i+1);
    }

    //Si la página actual se encuentra entre las primeras 3 páginas 
    ...
    //mostrar las primeras 2, puntos susppensivos, las últimas 3 páginas
